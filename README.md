# AdGuard Home Debian Package

This repository contains the Debian packaging configuration (`debian/` directory) for [AdGuard Home](https://github.com/AdguardTeam/AdGuardHome).

## Build Status

[![Build Package](https://github.com/crim50n/adguardhome-deb/actions/workflows/build.yml/badge.svg)](https://github.com/crim50n/adguardhome-deb/actions/workflows/build.yml)
...
```bash
sudo apt update
sudo apt install build-essential devscripts debhelper golang-go nodejs npm git
```
...
1.  **Clone this packaging repository:**
    ```bash
    git clone https://github.com/crim50n/adguardhome-deb.git
    ```
